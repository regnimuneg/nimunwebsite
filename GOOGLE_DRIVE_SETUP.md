...
```javascript
const DRIVE_FOLDER_ID = '1swUeOrB7yOO92fT1Dve4xPejuOl7ybno'; // Merch payment confirmations folder
...
```
DRIVE_WEBHOOK_URL=https://script.google.com/macros/s/YOUR_SCRIPT_ID/exec
```
