    ...
    <main className={styles.main}>
      ...
      <section className={styles.heroSection}>
          ...
          >
            ...
            {mobileMenuOpen && (
              <>
                ...
                />
                <div
                  className={`${styles.dropdownMenu} ${styles.mobileMenu}`}
                >
        ...
        <div className={styles.titleGrid}>
          {/* Mobile: Unified Title */}
          <div className={styles.mobileUnifiedTitle}>
            <div className={styles.unifiedTitleText}>
              <div className={styles.titleRow}>
                <span className={styles.heroWord}>Nile International</span>
                <div className={styles.heroIcon}>
                  <Image src="/image/png/globe 2.png" alt="Globe" width={40} height={40} />
                </div>
              </div>
              <div className={styles.titleRow}>
                <span className={styles.heroWord}>Model United Nations</span>
                <div className={styles.heroIcon}>
                  <Image src="/image/png/double arrow.png" alt="Arrow" width={40} height={40} />
                </div>
              </div>
            </div>
            <div className={styles.mobileApplyButton}>
              <Link href="/apply" className={styles.heroApplyButton}>
                Apply here
              </Link>
            </div>
          </div>
