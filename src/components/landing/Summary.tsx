    ...
    <section className={styles.summarySection}>
        ...
        <div className={styles.summaryTextBlock}>
          ...
          Nile International Model United Nations is a vibrant, student-led club dedicated to
           inspiring global awareness, diplomacy, and leadership. NIMUN has grown into a prestigious
            platform that welcomes participants from around the world, hosting international conferences, 
            bringing together students to engage in meaningful debates on 
      ...
      <div className={styles.summaryFooter}>
        <div className={styles.footerLeft}>
          <Image
            src="/image/png/j'25.png"
            alt="j'25"
            className={styles.j25Logo}
            width={58}
            height={58}
            priority
          />
